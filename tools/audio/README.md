...
se copian a `prototypes/slime_charge_movement/audio/slime/` y
`prueba_2/assets/audio/slime/` porque `res://` no puede atravesar una raíz de proyecto.
Aun así, hace falta una escucha humana para aprobar su resultado estético.
