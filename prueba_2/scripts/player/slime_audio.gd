...
const CHARGE_LOOP_STREAM: AudioStreamWAV = preload("res://audio/slime/slime_charge_loop.wav")
const CHARGE_FULL_STREAM: AudioStreamWAV = preload("res://audio/slime/slime_charge_full.wav")
const DASH_STREAM: AudioStreamWAV = preload("res://audio/slime/slime_dash.wav")
const FIZZLE_STREAM: AudioStreamWAV = preload("res://audio/slime/slime_fizzle.wav")
const IDLE_STREAM: AudioStreamWAV = preload("res://audio/slime/slime_idle.wav")
const IMPACT_STREAMS: Array[AudioStreamWAV] = [
	preload("res://audio/slime/slime_impact_01.wav"),
	preload("res://audio/slime/slime_impact_02.wav"),
]
const LAUNCH_STREAMS: Array[AudioStreamWAV] = [
	preload("res://audio/slime/slime_launch_01.wav"),
	preload("res://audio/slime/slime_launch_02.wav"),
]
const RECOVER_STREAMS: Array[AudioStreamWAV] = [
	preload("res://audio/slime/slime_recover_01.wav"),
	preload("res://audio/slime/slime_recover_02.wav"),
]
