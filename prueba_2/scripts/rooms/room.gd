...
const LampScene := preload("res://scenes/props/lamp.tscn")
const TankScene := preload("res://scenes/props/tank.tscn")
const DebrisScene := preload("res://scenes/props/debris.tscn")
const PuddleScene := preload("res://scenes/props/puddle.tscn")
