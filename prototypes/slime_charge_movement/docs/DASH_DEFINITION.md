...
> `prueba_2/actors/player/slime.gd`. La integración añadió dos reglas que **no**
...
| **DASH de habilidad** | `prueba_2/actors/player/slime.gd` | Recompensa del boss para cruzar huecos |
